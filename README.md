...
* `operation_code` — Procedure (`OperationType.TOMA_HUELLAS`). [All procedures](https://github.com/cita-bot/cita-bot/blob/9217b485e5f2ff35ef2ed8083fcc8a06c8be0a/bcncita/cita.py#L47-L57).
